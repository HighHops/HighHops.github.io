...
theme
  ? (root.attr("data-theme", theme),
    "light" === theme && themeChanger.prop("checked", !1),
    "dark" === theme && themeChanger.prop("checked", !0))
  : root.attr("data-theme", "light"),
  themeChanger.change(function () {
    $(this).prop("checked")
      ? (root.attr("data-theme", "dark"), localStorage.setItem("theme", "dark"), localStorage.setItem('dark__theme', true))
      : (root.attr("data-theme", "light"),
        localStorage.setItem("theme", "light"), localStorage.setItem('dark__theme', false));
        
  });
var toggleDataNavbar = $('[data-toggle="navbar"]'),
  dropToggle = $('[data-toggle="dropdown"]'),
  navCloser = $(".navbar-closer"),
  page = $(".page"),
  dataAsideToggle = $('[data-toggle="aside-nav"]'),
  dataType = $(".data-type__block "),
  mobileDrop = $(".mobile-drop-select"),
  downloadToggle = $('[data-toggle="download"]'),
  toggleApi = $('[data-toggle="api-nav"]'),
  toggleUploadType = $('[data-toggle="upload-type"]'),
  toggleIntegration = $('[data-toggle="integration-nav"]');
$(document).ready(function () {
  toggleDataNavbar.click(function (a) {
    a.preventDefault(),
    ...
    $(".toggle-password").click(function () {
      var a = $(this).closest(".form-group").find(".input-password");
      "password" === a.attr("type")
        ? (a.attr("type", "text"), $(this).addClass("active"))
        : ($(this).removeClass("active"), a.attr("type", "password"));
    }),
    dropToggle.click(function (a) {
      if ($(this).hasClass("drop-select")) {
        var e = $(this).find(".drop-selected");
        $(this)
          .parent()
          .find(".dropdown-item")
          .click(function () {
            if (
              ...
              var a = $(this).attr("data-type-img");
              $(".upload__content").removeClass("active"),
                $('[data-upload="' + a + '"]').addClass("active");
            }
          });
      }
      a.preventDefault(),
    ...
    $(document).mouseup(function (a) {
      dropToggle.is(a.target) ||
        0 !== dropToggle.has(a.target).length ||
        $(".dropdown").is(a.target) ||
        0 !== $(".dropdown").has(a.target).length ||
    ...
    dataAsideToggle.click(function (a) {
      a.preventDefault();
      var e = $(this).closest(".data__aside-list"),
        t = e.closest(".data__item"),
        o = e.find(dataAsideToggle),
        d = t.find($(".data__content"));
      o.removeClass("active"), $(this).addClass("active");
      var s = $(this).attr("data-target"),
        l = $('[id="' + s + '"]');
      d.addClass("hide"), l.removeClass("hide");
    }),
    mobileDrop.click(function () {
      ...
      var e = a.attr("data-target"),
        t = $('[data-drop="' + e + '"]');
      t.toggleClass("show-drop"),
        t.find(".mobile-drop-item").click(function (e) {
          e.preventDefault(),
            a.find(".mobile-drop-text").text($(this).text()),
            a.removeClass("active"),
            t.removeClass("show-drop");
        });
    }),
  ...
  setInterval(function () {
    101 !== a
      ? ($(".progress__line--2").css("width", a + "%"),
        $('[data-procent="progress-2"]').text("".concat(a++, "%")))
      : (clearInterval(),
  ...
  setInterval(function () {
    101 !== e
      ? ($(".progress__line--1").css("width", e + "%"),
        $('[data-procent="progress-1"]').text("".concat(e++, "%")))
      : (clearInterval(),
    ...
    dataType.click(function () {
      $(this).closest(".data-type").children().removeClass("active"),
        $(this).addClass("active");
    }),
    downloadToggle.click(function () {
      downloadToggle.removeClass("active"),
        ...
        "download-api" !== $(this).attr("data-target") &&
          ($(".download__type-linear").hasClass("active") ||
            ($('[data-by="download-by-month"]').is(":checked") &&
    ...
    $(".download__type-btn").click(function () {
      $(".download__type-btn").removeClass("active"),
        $(this).addClass("active"),
        $(".download__nav").addClass("download__nav--full"),
        $(this).hasClass("download__type-linear")
    ...
    toggleIntegration.click(function (a) {
      a.preventDefault(),
    ...
    $(document).mouseup(function (a) {
      $(".modal__content").is(a.target) ||
        0 !== $(".modal__content").has(a.target).length ||
    ...
    $(".next-process").click(function (a) {
      a.preventDefault(), $(".modal__process").addClass("active");
      var e = 95;
      setInterval(function () {
        100 !== e
          ? (e++, $(".modal__line").css("width", e + "%"))
          : (clearInterval(), $(".modal__body").addClass("connection-error"));
      }, 1e3);
    }),
    ...
    $(".remove-all").click(function () {
      var a = $(this).closest(".download__files").find(".downloaded");
      a.css("background-image", "none"), a.removeClass("downloaded");
    }),
    $(".file-delete").click(function () {
      var a = $(this).closest(".downloaded");
      a.css("background-image", "none"), a.removeClass("downloaded");
    });
});
var datepickerFirst = new Datepicker("#datepickerone"),
  datepickerSecond = new Datepicker("#datepickertwo");
